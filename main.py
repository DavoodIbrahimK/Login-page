...
class Login:
    ...
    def loginform(self):
        ...
        self.username_txt = Entry(frame_input, font=("times new roman", 15, "bold"),
    ...
    def login(self):
        ...
        if self.username_txt.get() == "" or self.password.get() == "":
            ...
            try:
                ...
                cur.execute('select * from registor where username=%s and password=%s'
    ...
    def register(self):
        ...
        if self.entry.get() == "" or self.entry2.get() == "" or self.entry3.get() == "" or self.entry4.get() == "":
            ...
            try:
                ...
                cur.execute("select * from registor where emailid=%s"
                ...
                if row != None:
                    ...
                    cur.execute("insert into registor values(%s,%s,%s,%s)"
